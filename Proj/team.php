    ...
    <!-- ===============================================-->
      ...
      <div class="content">
        ...
        <div class="mb-9">
         ...
         <!-- model -->
              <div class="col">
                <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal"  style="float: right;">+ Add new Team</button>
                      <div class="modal fade" id="exampleModal" tabindex="-1" style="display: none;" aria-hidden="true">
                        <div class="modal-dialog">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalLabel">Add Team Information </h5><button class="btn p-1" type="button" data-bs-dismiss="modal" aria-label="Close"><svg class="svg-inline--fa fa-xmark fs-9" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="xmark" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" data-fa-i2svg=""><path fill="currentColor" d="M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z"></path></svg><!-- <span class="fas fa-times fs-9"></span> Font Awesome fontawesome.com --></button>
                            </div>
                            <div class="modal-body">
                            <div class="mb-3">
                                <label class="form-label" for="project type">Name </label>
                                <input class="form-control" id="team_name" type="text" placeholder="Noberth Nikombo" />
                            </div>

                            <div class="mb-3">
                                <label class="form-label" for="project type">Title/Role </label>
                                <input class="form-control" id="team_name" type="text" placeholder="Front end Dev" />
                            </div>

                            <div class="mb-3">
                                <label class="form-label" for="exampleFormControlInput">Contact Information </label>
                                <input class="form-control" id="description" type="text" placeholder="noberthbarik@gmail.com" />
                            </div>
                            
                            <div class="mb-3">
                                <label class="form-label" for="exampleFormControlInput">Assigned Projects </label>
                                <input class="form-control" id="description" type="text" placeholder="NHC" />
                            </div>

                            <div class="mb-3">
                                <label class="form-label" for="exampleFormControlInput">Skills & Expertise </label>
                                <input class="form-control" id="description" type="text" placeholder="Software Engineer" />
                            </div>

                            <div class="mb-3">
                                <label class="form-label" for="exampleFormControlInput">Department</label>
                                <input class="form-control" id="description" type="text" placeholder="Computer Dep." />
                            </div>

                            <div class="mb-3">
                                <label class="form-label" for="exampleFormControlInput">Availability</label>
