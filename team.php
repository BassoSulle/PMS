                      ...
                      <div class="modal fade" id="exampleModal" tabindex="-1" style="display: none;" aria-hidden="true">
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="mb-3">
                                <label class="form-label" for="project type">Team Name </label>
                                <input class="form-control" id="team_name" type="text" placeholder="" />
                            </div>
                            <div class="mb-3">
              ...
              <table class="table fs-9 mb-0 border-top border-translucent">
                ...
                <tbody class="list" id="project-list-table-body">
                  <tr class="position-static">
                    ...
                    <td class="align-middle time white-space-nowrap ps-0 projectName py-4">Dealing with database and all busness logics</td>
                  ...
                  <tr class="position-static">
                    ...
                    <td class="align-middle time white-space-nowrap ps-0 projectName py-4">Front-end Team</td>
                    <td class="align-middle time white-space-nowrap ps-0 projectName py-4">User Interface designing</td>
                    <td class="align-middle time white-space-nowrap ps-0 projectName py-4">
                        <div style="display: flex; align-items: center;">
